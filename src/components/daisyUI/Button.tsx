export function Button() {
  return (
    <div className="grid w-1/2 grid-cols-2 gap-2">
      <button className="flex h-6 w-max items-center rounded-full bg-green-600 px-2 py-1 text-sm font-medium text-white hover:bg-green-700 active:bg-green-800 disabled:bg-gray-400">
        Button
      </button>
      <button
        disabled
      ...
      <button className="flex h-6 w-max items-center justify-center gap-2 rounded-full bg-green-600 px-2 py-1 text-center text-sm font-medium text-white hover:bg-green-700 active:bg-green-800 disabled:bg-gray-400">
        Button
        <svg
